...
import com.nettactic.mall.widget.JingDongListView;

import java.util.ArrayList;
import java.util.Arrays;
import java.util.List;

public class JingDongPullToRefreshActivity extends Activity implements JingDongListView.OnJingDongRefreshListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.jingdong_activity_pulltorefresh);
