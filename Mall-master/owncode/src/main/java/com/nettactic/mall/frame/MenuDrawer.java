package com.nettactic.mall.frame;
...
public abstract class MenuDrawer extends ViewGroup {
	 ...
	 * 
	 * @param activity
	 *            The mActivity that the MenuDrawer will be attached to.
	 ...
	 * 
	 * @param activity
	 *            The mActivity the menu drawer will be attached to.
	 * @param dragMode
...
//		mDropShadowDrawable = context.getResources().getDrawable(R.drawable.shadow_nav);
