...
public class JingDongListView extends ListView implements AbsListView.OnScrollListener{
	...
	private JingDongFirstSetpView jingDongFirstSetpView;
	private JingDongSecondStepView jingDongSecondStepView;
	...
	private void init(Context context) {
		...
		jingDongFirstSetpView = (JingDongFirstSetpView) headerView.findViewById(R.id.first_step_view);
		jingDongSecondStepView = (JingDongSecondStepView) headerView.findViewById(R.id.second_step_view);
		jingDongSecondStepView.setBackgroundResource(R.drawable.second_step_animation);
		secondAnimation = (AnimationDrawable) jingDongSecondStepView.getBackground();
				...
				case MotionEvent.ACTION_MOVE:
					...
					if (state!=REFRESHING && isRecord ) {
						...
						if (state == PULL_TO_REFRESH) {
							...
							jingDongFirstSetpView.setCurrentProgress(currentProgress);
							jingDongFirstSetpView.postInvalidate();
						}
	...
	private void changeHeaderByState(int state){
		...
		case DONE:
			headerView.setPadding(0, -headerViewHeight, 0, 0);
			jingDongFirstSetpView.setVisibility(View.VISIBLE);
			secondAnimation.stop();
			jingDongSecondStepView.setVisibility(View.GONE);
			break;
		...
		case REFRESHING:
			...
			jingDongFirstSetpView.setVisibility(View.GONE);
			jingDongSecondStepView.setVisibility(View.VISIBLE);
			secondAnimation.stop();
