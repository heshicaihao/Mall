 ...
 */
public class LeftAndRightMarqueeView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public LeftAndRightMarqueeView(Context context) {
        this(context, null);
    }

    public LeftAndRightMarqueeView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LeftAndRightMarqueeView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.LeftAndRightMarqueeView, defStyleAttr, 0);
        mTextColor = a.getColor(R.styleable.LeftAndRightMarqueeView_textcolor, Color.RED);
        mTextSize = a.getDimension(R.styleable.LeftAndRightMarqueeView_textSize, 48);
        mIsRepeat = a.getBoolean(R.styleable.LeftAndRightMarqueeView_isRepeat, false);
        mStartPoint = a.getInt(R.styleable.LeftAndRightMarqueeView_startPoint, 0);
        mDirection = a.getInt(R.styleable.LeftAndRightMarqueeView_direction, 0);
        mSpeed = a.getInt(R.styleable.LeftAndRightMarqueeView_speed, 20);
        a.recycle();
